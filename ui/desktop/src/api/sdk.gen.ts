 ...
 */
export const generateExtensionFromPrompt = <ThrowOnError extends boolean = false>(options: Options<GenerateExtensionFromPromptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GenerateExtensionFromPromptResponses, GenerateExtensionFromPromptErrors, ThrowOnError>({
